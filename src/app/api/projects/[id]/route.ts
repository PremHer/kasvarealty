...
export async function PUT(
  ...
  try {
    ...
    // Solo el gerente del proyecto o un usuario con rol superior puede actualizarlo
    if (
      proyectoActual.gerenteId !== usuario.id &&
      !['ADMIN', 'SUPER_ADMIN', 'GERENTE_GENERAL'].includes(usuario.rol)
    ) {
      return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    // Solo el gerente del proyecto o un usuario con rol superior puede eliminarlo
    if (
      proyectoActual.gerenteId !== usuario.id &&
      !['ADMIN', 'SUPER_ADMIN', 'GERENTE_GENERAL'].includes(usuario.rol)
    ) {
