...
export default function ReservasPage() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (filters.proyectoId && filters.proyectoId !== 'TODOS') params.append('proyectoId', filters.proyectoId)
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select
              ...
              onValueChange={(value) => setFilters({ ...filters, proyectoId: value })}
            >
              <SelectTrigger>
                ...
                {data?.reservas?.map((reserva: ReservaWithRelations) => {
                  ...
                  return (
                    <TableRow key={reserva.id}>
                      ...
                      <TableCell>{reserva.proyecto.nombre}</TableCell>
